		...
		while($registro = mysqli_fetch_array($resultado_id, MYSQLI_ASSOC)){
			...
			echo '<a href"#" class="list-group-item">';
					...
					// Verificação na consulta dos autores.	  
		  			...
		  			echo '<br/><br/>';			     
					echo '<button class="btn btn btn-primary btn-block btn-inserir-carrinho" data-id_livro="'.$registro['id'].'" id="btn-inserir-carrinho'.$registro['id'].'"">Adicionar no carrinho</button>'; 
