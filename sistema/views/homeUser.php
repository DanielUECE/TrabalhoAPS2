...
<body>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="homeUser.php" class="active">Inicio</a></li>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1>Livraria</h1>
									<h2>A maior loja de livros</h2>
									<p>Descrição da loja ou de alguma promoção - Ou deixa apenas o banner. </p>
									<!--<button type="button" class="btn btn-default get">Get it now</button> -->
								</div>
								<div class="col-sm-6">
									<img src="../images/home/carrousel_01.png" class="girl img-responsive" alt="" />
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="../images/home/carrousel_02.jpg" class="girl img-responsive" alt="" />
								<!--	<img src="images/home/carrousel_02.jpg"  class="pricing" alt="" /> -->
								</div>
							</div>
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="../images/home/carrousel_03.jpg" class="girl img-responsive" alt="" />
			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Itens Mais Vendidos</h2>
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="../images/home/livro1.jpg" alt="" />
											<h2>PREÇO</h2>
											<p>Livro 1</p>
								...
								<div class="choose">
									<ul class="nav nav-pills nav-justified">
										<li><a href="#"><i class="fa fa-plus-square"></i>Carrinho</a></li>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="../images/home/livro2.jpg" alt="" />
										<h2>PREÇO</h2>
										<p>Livro 2</p>
														<!-- botão de compra abaixo das imagens-->
									<!--	<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> -->
									</div>

											<!-- Animação para sombrear a imagem ao passar o mouse-->
								<!--	<div class="product-overlay">
										<div class="overlay-content">
											<h2>PREÇO</h2>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="../images/home/livro3.jpg" alt="" />
										<h2>PREÇO</h2>
										<p>Livro3</p>
									<!--	<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> -->
									</div>
	...
	<footer id="footer"><!--Footer-->
		...
		<!-- Colunas de informações/links no final da página
